...
export default function Cam() {
  ...
  const run = () => { try { setOut(inp.replace(/(?:^|\s+)(\w)/g, (m,p,i)=>i===0?p.toLowerCase():p.toUpperCase())) } catch(e) { setOut("エラー"); } };
  return (
    <>
      <ToolStickyHeader title="キャメルケース変換" className="bg-gray-800 text-white" />
