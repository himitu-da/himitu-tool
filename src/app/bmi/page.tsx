...
export default function BMIPage() {
  ...
  return (
    <ToolPageLayout title="BMI計算機" maxWidth="4xl">
      <ToolPanel className="max-w-4xl mx-auto space-y-8">
        <div className="grid md:grid-cols-2 gap-6">
          {/* 左カラム: 入力と結果 */}
          <div className="space-y-6">
            <div className={`p-6 rounded-2xl transition-colors ${blockCls}`}>
              ...
              {isValid && bmi ? (
                <div className="animate-in fade-in zoom-in-95 duration-300">
                  ...
                  <div className="flex flex-wrap gap-4 justify-center text-sm mt-6">
                    <div className={`pt-2 px-4 pb-3 rounded-xl min-w-[120px] transition-colors ${blockCls}`}>
          ...
          <div className="space-y-6">
            <div className={`p-6 rounded-2xl transition-colors ${blockCls}`}>
              ...
              <div className="relative pt-8 pb-4">
                ...
                {isValid && bmi && (
                  <div
                    className="absolute top-2 w-0 h-0 transition-all duration-300 ease-out text-current"
                    style={{
        ...
        <div className={`mt-12 p-6 md:p-8 rounded-2xl space-y-8 transition-colors ${blockCls}`}>
          <div>
