...
export default function Bin() {
  ...
  const run = () => { try { setOut(inp.split("").map(c=>c.charCodeAt(0).toString(2).padStart(8,"0")).join(" ")) } catch(e) { setOut("エラー"); } };
  return (
    <>
      <ToolStickyHeader title="テキスト → 2進数" className="bg-gray-800 text-white" />
